...
public record EntityData(Identification type, NbtCompound tag) {
    public static final class Controller
                        implements TransformingItemComponentValue<CustomData, EntityData>
    {
        @Override
        public EntityData transform(CustomData value) {
        ...
        @Override
        public CustomData untransform(EntityData value) {
