...
public final class PlaceholderAPI {
    ...
    public static BaseComponent<?> replacePlaceholders_ServerOnly(BaseComponent<?> message) {
        ...
        return COFromNative.from(Placeholders.COMMON_PLACEHOLDER_PARSER.parseComponent(
                TextNode.convert(COToNative.from(message)),
                PlaceholderContext.of(AvoidInternal.getServer().overworld()).asParserContext()
        ));
    }
