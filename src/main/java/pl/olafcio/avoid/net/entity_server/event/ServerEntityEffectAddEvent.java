...
public final class ServerEntityEffectAddEvent extends Cancellable implements EntityEvent {
    public final Entity entity;
    public final EffectInstance effect;

    public ServerEntityEffectAddEvent(Entity entity, EffectInstance effect) {
        this.entity = entity;
        this.effect = effect;
    }
