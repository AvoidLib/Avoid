...
public final class ServerEntityEffectUpdateEvent extends Cancellable implements EntityEvent {
    public final Entity entity;
    public final EffectInstance effect;

    public ServerEntityEffectUpdateEvent(Entity entity, EffectInstance effect) {
        this.entity = entity;
        this.effect = effect;
    }
