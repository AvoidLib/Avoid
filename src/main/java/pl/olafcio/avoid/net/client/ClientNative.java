...
final class ClientNative {
    ...
    static boolean inSingleplayer() {
        return Minecraft.getInstance().isLocalServer();
    }

    static boolean inSingleplayerPublished() {
        return Minecraft.getInstance().isSingleplayer();
    }

    static boolean isNameBanned() {
        return Minecraft.getInstance().isNameBanned();
    }

    @Nullable
    static ServerEntry getCurrentServer() {
