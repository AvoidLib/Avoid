...
public class ItemComponents {
    ...
    public static final ItemComponentType<DamageType> DAMAGE_TYPE = register("damage_type", new DamageType.Controller());
    ...
    public static final ItemComponentType<BlockEntityData> BLOCK_ENTITY_DATA = register("block_entity_data", new BlockEntityData.Controller());
    ...
    public static final ItemComponentType<TropicalFishPattern> TROPICAL_FISH_PATTERN = register("tropical_fish/pattern", new TropicalFishPattern.Controller());
