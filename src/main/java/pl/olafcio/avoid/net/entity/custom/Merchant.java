...
public abstract class Merchant extends pl.olafcio.avoid.net.entity.type.Merchant {
    public Merchant(int id, Object... args) {
        super(
                id,
                (EntityType) args[0],
                (IVect3) args[1],
    ...
    public final int getUnhappyCounter() {
        return super.getUnhappyCounter();
    }

    @Override
    public final void setUnhappyCounter(int value) {
        super.setUnhappyCounter(value);
    }

    @Override
    public final int getMerchantXP() {
        return super.getMerchantXP();
    }

    @Override
    public final void setMerchantXP(int value) {
        super.setMerchantXP(value);
    }
    ...
    @Override
    public final @org.jspecify.annotations.Nullable Player getTradingPlayer() {
        return super.getTradingPlayer();
    }

    @Override
    public final void setTradingPlayer(@org.jspecify.annotations.Nullable Player player) {
        super.setTradingPlayer(player);
    }

    @Override
    public final boolean isTradingWith(@NonNull Player player) {
        return super.isTradingWith(player);
    }

    @Override
    public final void openTradingScreen(Player player, BaseComponent<?> title, int merchantLevel) {
        super.openTradingScreen(player, title, merchantLevel);
    }

    @Override
    public final boolean canRestock() {
        return super.canRestock();
    }
