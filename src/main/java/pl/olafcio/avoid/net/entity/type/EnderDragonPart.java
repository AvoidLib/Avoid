...
@AutoEntityAttach
@Class(net.minecraft.world.entity.boss.enderdragon.EnderDragonPart.class)

@ApiStatus.Experimental

public class EnderDragonPart extends Entity {
    public EnderDragonPart(int id, EntityType type, IVect3 position, IVect3 velocity, UUID uuid, BaseComponent<?> name, net.minecraft.world.entity.Entity underlyingEntity) {
