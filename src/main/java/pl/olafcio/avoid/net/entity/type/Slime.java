...
@AutoEntityAttach
@Class(net.minecraft.world.entity.monster.Slime.class)

@ApiStatus.Experimental

public class Slime extends Entity {
    public Slime(int id, EntityType type, IVect3 position, IVect3 velocity, UUID uuid, BaseComponent<?> name, net.minecraft.world.entity.Entity underlyingEntity) {
