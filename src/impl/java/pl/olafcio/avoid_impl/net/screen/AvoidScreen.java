...
import pl.olafcio.avoid.net.screen.ScreenAccessor;
...
public class AvoidScreen extends Screen {
    ...
    public AvoidScreen(pl.olafcio.avoid.net.screen.Screen screen) {
        super(COToNative.from(screen.getAccessibilityTitle()));
    ...
    public void init() {
        ...
        ScreenAccessor.setWidth(screen, width);
        ScreenAccessor.setHeight(screen, height);
    ...
    public void resize(int width, int height) {
        ...
        ScreenAccessor.resize(screen, width, height);
    }
    ...
    public boolean isMouseOver(double x, double y) {
        return ScreenAccessor.isMouseOver(screen, x, y);
    }
